# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/05_fastAIExample.ipynb.

# %% auto 0
__all__ = ['animals_folder_create', 'download_animal_images', 'verify_pics', 'resize_pics', 'data_folder']

# %% ../nbs/05_fastAIExample.ipynb 16
#|code-fold: true
